...
%% Data
OutputFileName = "Optimising Backup and Renewables_LCOH 100% solar";

[SolarData, WindData, HourlyElectricityPrices] = ImportRawData();

% Initial run: PV_GS: 1, ReM_OcM_Ratio: 1, ReM: 4, Storage_hrs: 24
%              Backup: 17.9%, LCOH: 18.3251
%
% PV_gen_share = 1; % percentage as a decimal 21 cases
% ReM_OcM_Ratio = 0:1:5; % 6 cases
% REM = 1:1:10; % 10 cases
% Storage_hrs = 1:25; % 25 cases

PV_gen_share = 1; % percentage as a decimal 1 case
ReM_OcM_Ratio = 0:0.1:2; % 21 cases
REM = 3:0.1:5; % 21 cases
Storage_hrs = 15:30; % 15 cases

% Optimised value is PV: 1, ReM_OcM: 0.5, ReM: 4.6, Storage_hrs: 15 with backup and LCOH of 19.9% and 12.72014
