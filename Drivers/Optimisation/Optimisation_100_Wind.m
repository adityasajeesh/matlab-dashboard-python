...
%% Data
OutputFileName = "Optimising Backup and Renewables_LCOH 100% wind";

[SolarData, WindData, HourlyElectricityPrices] = ImportRawData();

PV_gen_share = 0; % percentage as a decimal 1 case
ReM_OcM_Ratio = 0:0.1:3; % 31 cases
REM = 1:0.1:4; % 41 cases
Storage_hrs = 20:75; % 66 cases

% Optimised value is PV: 0, ReM_OcM: 0.5, ReM: 2.9, Storage_hrs: 21 with backup and LCOH of 19.7% and 10.5919
