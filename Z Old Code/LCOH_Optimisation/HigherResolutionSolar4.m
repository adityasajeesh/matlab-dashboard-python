...
OutputFileName = "HighResolutionSolarCC";

[SolarData, WindData, HourlyElectricityPrices] = ImportRawData();

PV_gen_share = 1;
ReM_OcM_Ratio = 0.35:0.01:0.55; % 21 cases (originally started with 1:-0.1:0.1)
REM = 2.5:0.1:5.5; %21 cases (originally started with 1:10)
Storage_hrs = 1:1:24; % 24 cases
CaseNumber = 1;
