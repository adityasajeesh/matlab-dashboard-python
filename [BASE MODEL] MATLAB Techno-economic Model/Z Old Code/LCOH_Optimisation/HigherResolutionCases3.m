...
OutputFileName = "HighResolutionTestingFinalCurtailmentChange";

[SolarData, WindData, HourlyElectricityPrices] = ImportRawData();

PV_gen_share = 0.35:0.01:0.55; % 21 cases
ReM_OcM_Ratio = 0.45:0.01:0.60; % 16 cases
REM = 1.9:0.1:2.4; %6 cases
Storage_hrs = 1:1:12; % 24 cases
CaseNumber = 1;
